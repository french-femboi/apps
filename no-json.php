...
<head>
    ...
    <meta property="og:site_name" content="Catappz | Data error">
    <meta property="og:title" content="Catappz | Data error">
    <meta property="og:description" content="Error while loading app data...">
    <meta name="description" content="Error while loading app data..." />
    <meta property="og:image" content="/assets/favicon.png">
    <meta content="#a443d1" data-react-helmet="true" name="theme-color">
    <title>Catappz | Data error</title>
...
<body>
    ...
    <div class="page">
        ...
        <div class="page-inner-content">
            ...
            <h1>DATA ERROR</h1>
            <p>There was an error while loading the data for that app. Maybe the app isn't added to the system yet?<br>
